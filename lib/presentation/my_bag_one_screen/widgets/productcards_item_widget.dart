...
class ProductcardsItemWidget extends StatelessWidget {
  ProductcardsItemWidget(this.productcardsItemModelObj);

  ProductcardsItemModel productcardsItemModelObj;

  var controller = Get.find<MyBagOneController>();
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomIconButton(
                                  ...
                                  width: 36,
                                  variant:
                                      IconButtonVariant.OutlineBlack90019_1,
